...
exports.orderMissions = exports.groupMissionsByDate = exports.sortMissionsByDate = void 0;
const sortMissionsByDate = (missions, dateTypeMission) => {
    return missions.sort((a, b) => {
        return (new Date(a[dateTypeMission]).getTime() -
...
exports.groupMissionsByDate = groupMissionsByDate;
const orderMissions = (missions, dateTypeMission) => {
    const sortedMissions = (0, exports.sortMissionsByDate)(missions, dateTypeMission);
    return (0, exports.groupMissionsByDate)(sortedMissions, dateTypeMission);
};
